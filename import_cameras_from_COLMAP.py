...
with open(r"C:\Users\Luscias\Desktop\images.txt", "r") as lines:
    ...
    for c,line in enumerate(lines):
        if c%2 == 0:
            ...
            Eplus = np.array([IMAGE_ID, QW, QX, QY, QZ, TX, TY, TZ, CAMERA_ID, NAME]) #Eplus = np.array([IMAGE_ID, QW, QX, QY, QZ, TX, TY, TZ, CAMERA_ID, NAME[:-4]])
